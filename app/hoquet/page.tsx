      ...
      {isOpen && (
        <div className="fixed inset-0 z-[500] flex items-center justify-center p-4 md:p-10">
          ...
          >
            ...
            <button 
              onClick={onClose}
              className="absolute -top-12 right-0 text-white font-black uppercase text-[13px] tracking-widest hover:text-orange-500 transition-colors"
            >
              Fermer ×
            </button>
          </motion.div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center justify-between pt-6 border-t border-white/5 mt-4">
                    ...
                    <button 
                      ...
                      className="bg-white text-[#0f092e] px-8 py-3.5 rounded-2xl font-black uppercase text-[12px] hover:bg-orange-500 hover:text-white transition-all active:scale-95 shadow-lg shadow-white/5"
                    >
                      Ajouter
                    </button>
                  </div>
